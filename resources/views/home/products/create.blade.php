...
<section class="mb-10 flex items-end gap-4">
    ...
    <div>
        <h1 class="text-4xl font-extrabold text-primary tracking-tight mb-2">Nuevo Producto</h1>
        <p class="text-on-surface-variant font-body">Registra un nuevo artículo en el catálogo maestro.</p>
    </div>
</section>
    ...
    <div class="bg-surface-container-lowest p-8 rounded-[2.5rem] shadow-sm border border-outline-variant/30">
        <form method="POST" action="{{ route('products.store') }}" class="space-y-8">
            ...
            <div class="pt-6 border-t border-outline-variant/30 flex items-center justify-end gap-4">
                ...
                <button type="submit" class="bg-primary hover:bg-primary-container text-white px-8 py-4 rounded-full flex items-center gap-2 transition-all font-headline font-bold shadow-lg shadow-primary/20 transform active:scale-95">
