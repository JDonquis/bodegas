        ...
        <div class="card-body">
          <form method="POST" action="{{ route('products.store') }}">
            ...
            <div class="mb-6">
              ...
              <input type="text" class="form-control" name="productName" value="{{ old('productName') }}" id="input-name-patient" placeholder="Nombre">
            </div>
            <div class="mb-6">
              <label class="form-label" for="basic-default-email">Precio de venta</label>
              <div class="input-group input-group-merge">
                <input type="number" step="0.01" min="0" id="input-lastname-patient" value="{{ old('sellPrice') }}" name="sellPrice" class="form-control" placeholder="Precio de venta" aria-label="john.doe" aria-describedby="basic-default-email2">
              </div>
            </div>
